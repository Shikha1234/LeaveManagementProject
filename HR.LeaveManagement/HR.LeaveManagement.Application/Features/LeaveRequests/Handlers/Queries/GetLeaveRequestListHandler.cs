...
using HR.LeaveManagement.Application.Features.LeaveRequests.Handlers.Request;
...
namespace HR.LeaveManagement.Application.Features.LeaveRequests.Handlers.Queries
{
    public class GetLeaveRequestListHandler : IRequestHandler<GetLeaveRequestListRequest, List<LeaveRequestListDto>>
    {
        ...
        {
            var leaveRequest = await _leaveRequestRepository.GetAllLeaveAllocationsWithDetails();
